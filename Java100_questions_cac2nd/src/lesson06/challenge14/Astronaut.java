 ...
 * メソッドpublic boolean compareFuelprivate(double fuelNum, double lightYear)を
...
class Spaceship {
	...
	public boolean compareFuelprivate(double fuelNum, double lightYear) {

		boolean isCheck = false;

		double ans = Math.max(fuelNum, lightYear);
...
public class Astronaut {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに適切な処理を記述する
		isCheck = spaceship.compareFuelprivate(fuelNum, lightYear);
