...
public class CastleTown {
	...
	public static void main(String[] args) {
		...
		Samurai[] ArraySamurais = new Samurai[5];

		for (int i = 0; i < ArraySamurais.length; i++) {

			int num = (int) (Math.random() * 10) % 2;
			if (num == 0) {
				ArraySamurais[i] = new Retainer();
			} else {
				ArraySamurais[i] = new Ronin();
			}
		}
		...
		//ここに適切な処理を記述
		for (Samurai sanusanu : ArraySamurais) {

			System.out.println(sanusanu.getClass());
		}
